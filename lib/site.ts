export const SITE = {
  name: "Superachiever",
  descriptor: "Single Family Office Benefits",
  ...
  /** The sub-offerings under this property, in Josh's own words. */
  offerings: [
    "Participate for Supermind Superpowers",
    "Participate for Personal Success Puzzle",
    "Participate for Business Success Puzzle",
  ],
  domain: "superachiever.xyz",
  url: "https://superachiever.xyz",
  /** Whether this property sells a membership directly. */
  sells: true,
} as const
